({
    ...
    bindDataChange: function() {
        ...
        this.context.on('button:commission_select_change:click', this.onDiscountChanged, this);
    ...
    onDiscountChanged: function(model, field, evt) {
        ...
        if (this.model === model) {
            ...
            if (field.name === 'select_commission_percent_button') {
                isPercent = true;
            }
    ...
    updateCurrencyStrings: function() {
        ...
        if (this.model.has('currency_id')) {
            ...
            btn = _.find(this.def.buttons, function(button) {
                return button.name === 'select_commission_amount_button';
            });
    ...
    toggleDropdown: function(evt) {
        ...
        var $fieldSet = this.$el.parents('.quote-commission-percent');
