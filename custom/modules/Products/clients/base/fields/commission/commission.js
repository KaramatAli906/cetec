({
     ...
     * @inheritdoc
     *
     * Listen for the commission_select_c field to change, when it does, re-render the field
     */
    bindDataChange: function() {
        this._super('bindDataChange');

        // if commission select changes, we need to re-render this field
        this.model.on('change:commission_select_c', this.render, this);
    },
    ...
    _loadTemplate: function() {
        if (this.model.get('commission_select_c') == true) {
    ...
    /**
     * Validate the commission field as a number - do not allow letters
     *
