 ...
 * PLACE ANY CUSTOMIZATIONS IN CETEC_Clients
 */

require_once 'include/SugarObjects/templates/company/Company.php';

class CETEC_Clients_sugar extends Company {
    public $new_schema = true;
    public $module_dir = 'CETEC_Clients';
    public $object_name = 'CETEC_Clients';
    public $table_name = 'cetec_clients';
