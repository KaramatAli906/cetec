 ...
 * PLACE ANY CUSTOMIZATIONS IN CETEC_Vendors
 */

require_once 'include/SugarObjects/templates/company/Company.php';

class CETEC_Vendors_sugar extends Company {
    public $new_schema = true;
    public $module_dir = 'CETEC_Vendors';
    public $object_name = 'CETEC_Vendors';
    public $table_name = 'cetec_vendors';
